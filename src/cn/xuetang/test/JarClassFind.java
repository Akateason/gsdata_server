...
public class JarClassFind {
    ...
    static public void main(String[] args) {
		 ...
		 */
        String className = "org/cyberneko/html/HTMLTagBalancingListener"; // 要查询的class,要带包名的类名
        String libPath = "E:\\IdeaWork\\task_2.0\\lib";
//        String libPath = "E:\\IdeaWork\\WxNum\\WebContent\\WEB-INF\\lib"; // 所要查找的JAR包的目录
